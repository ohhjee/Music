    ...
    <div>
        ...
        <div class="lg:flex lg:space-x-3 mt-3 lg:mt-0">
            ...
            <div class="w-full relative hidden lg:flex">
                <div class=" w-full lg:w-8/12 xl:w-7/12 bg-blue-300/40 lg:bg-blue-300/90 h-full rounded-[35px]">
                    <div class="text absolute w-full flex flex-col items-start justify-center lg:block lg:w-1/2 h-full space-y-3 p-[2rem] z-10">
                    ...
                    <div class="absolute w-full h-full">
                        <div class="bg-[url('../../assets/images/images/Vector.svg')] overflow-hidden rounded-[35px] h-full bg-no-repeat absolute top-0 left-0 bottom-0 lg:w-8/12 xl:w-7/12 bg-right-top right-0"></div>
    
                        <div class="bg-[url('../../assets/images/images/singer.png')] h-full bg-no-repeat bottom-0 left-0 top-0 bg-right-top right-0 absolute lg:w-8/12 xl:w-7/12"></div>
                    </div>
            ...
            <div class=" sm:w-full  lg:hidden space-y-5 ">
                <div class=" w-full  bg-blue-300/40 relative lg:bg-blue-300/90  rounded-[35px]">
                    ...
                    <div class="absolute top-0 w-full h-full">
                        <div class="bg-[url('../../assets/images/images/Vector.svg')] overflow-hidden rounded-[35px] h-full bg-no-repeat absolute top-0 left-0 bottom-0 w-full bg-right-top right-0"></div>
        ...
        <div class="w-full bg-black/20  backdrop-blur-md px-5 py-[10px] fixed left-0 bottom-0">
            <div class="absolute w-full h-full top-0 left-0 bottom-0 -z-10 right-0">
                <div class="bg-[url('../../assets/images/images/Rectangle 14 (1).png')] w-full h-full blur-sm bg-no-repeat"></div>
            </div>
                    ...
                    <div class="items-center flex flex-col space-y-[.5rem] justify-center">
                        ...
                        <div id="Music_controller" class="flex space-x-[2rem] items-center">
                            ...
                            <div class="flex flex-row items-center space-x-[2rem]">
                                <!-- SHUFFLE -->
                                <div class="hidden sm:block" @click="shuffle">
                                    <div>
                                        <i class="fa-solid fa-shuffle text-white"></i>
                                    </div>
                                </div>
                                <!-- PREV -->
                                <div class="hidden sm:flex border rounded-full h-7 w-7 items-center justify-center" @click="prev">
                                    <i class="fa-solid fa-backward-step text-white  flex items-center justify-center"></i>
                                </div>
                                <!-- PLAY -->
                                <div class="">
                                    <div @click="plays" v-if="!isPlaying" class="h-7 w-7 rounded-full bg-[blue] overflow-hidden flex items-center justify-center ">
                                ...
                                <!-- NEXT -->
                                <div>
                                    <div @click="next" class="h-7 w-7 border rounded-full flex items-center justify-center">
